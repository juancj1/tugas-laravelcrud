...
<x-dropdown align="right" width="48"> 
    ...
    <x-slot name="content"> 
        ...
        <div class="relative z-10 max-sm:ml-5 max-sm:mt-10 ">

            <div class="absolute right-24 -top-1 z-30 lg:z-30  ">
            
                <img class="" src={{asset('foto/person1.png')}} alt="">

            </div>

            <div class="absolute right-16 -top-5 z-20 max-sm:w-[150px]">
            
                <img class="" src="foto/line1.png" alt="">

            </div>

            <div class="absolute right-[450px] top-80 z-20 max-sm:-left-10 max-sm:w-[150px] max-sm:top-32 ">
            ...
            <div class=" max-sm:pt-72 ">

                <h1 class="text-[#151F3C] pt-36 text-7xl max-w-[600px] font-bold max-sm:pl-10 max-xl:pb-10 max-sm:text-3xl ">
                    The Best <span class="text-[#FF994F]">Courses</span>  With the Best Mentors
                </h1>
                
                <article class="text-base max-w-[550px] max-sm:pl-10 pt-6 max-sm:text-sm">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec fermentum massa sit amet porta efficitur.
                </article>
          

                <div class="pt-20 pb-32 max-sm:pl-10">
                    <a href="./contact " class="bg-[#FF994F] text-white font-bold border-2 py-4 px-12 hover:bg-secondary  rounded-full border-[#FF994F]  " id="get">Hubungi kami</a>
                </div>
...
<div class="bg-[#FF994F] pb-10 pt-10">
    <div class=" container mx-auto bg-[#FFFAF2] pt-10 pb-10 pl-10 pr-10 ">
    ...
    <div>
            ...
            <x-text-input id="name" class="block mt-1 w-1/2 " type="text" name="name" :value="old('name')"  autofocus />
            <x-input-error :messages="$errors->get('name')" class="mt-2" />
        </div>

        <div>
            <x-input-label for="email" class="text-black"  :value="__('Email')" />
            <x-text-input id="email" class="block mt-1 w-1/2 " type="email" name="email" :value="old('email')"  autofocus />
            <x-input-error :messages="$errors->get('email')" class="mt-2" />
        </div>

        <div class="flex flex-col gap-4">
                        <x-input-label class="text-black" for="name" :value="__('gender')" />
                        <div class="flex gap-4">
                            <x-text-input id="laki" class="block" type="radio" name="gender"
                                value="L" autofocus />
                            <x-input-label class="text-black" for="laki" :value="__('Laki-laki')" />

                            <x-text-input id="perempuan" class="block" type="radio" name="gender"
                                value="P" autofocus />
                            <x-input-label class="text-black" for="perempuan" :value="__('Perempuan')" />
                        </div>
                    </div>

        <div>
            <!-- <x-input-label for="phone" :value="__('Phone number')" />
            <x-text-input id="phone" class="block mt-1 w-70%" type="integer" name="phone" :value="old('phone')"  autofocus />
            <x-input-error :messages="$errors->get('phone')" class="mt-2" /> -->
            <x-input-label for="phone" class="text-black" :value="__('phone')" />
            <x-text-input id="phone" class="block mt-1 w-1/2 " type="text" name="phone" :value="old('phone')"  autofocus />
            <x-input-error :messages="$errors->get('phone')" class="mt-2" />
        </div>

        <!-- <div>
            <x-input-label for="gender" :value="__('gender')" />
            <x-text-input id="gender" class="block mt-1 w-70%" type="text" name="gender" :value="old('gender')"  autofocus />
