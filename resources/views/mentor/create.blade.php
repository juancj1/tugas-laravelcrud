                ...
                <div id="left-side" class="flex gap-10 items-center">
                    ...
                    <nav class="fixed w-full h-full top-0 p-10 lg:p-0 lg:relative bg-primary lg:bg-transparent z-20 lg:z-0 ">
                        <ul class="flex flex-col lg:flex-row gap-y-5 gap-x-2 items-center">
                            ...
                            <li class="{{ request()->is('mentor') ? 'active' : '' }}"><a class="active" href="/mentor">Mentor</a></li>
                            <li class="has-child">
                                <a href="#">About Us</a>
        ...
        <form method="POST" action="{{ route('logout') }}"> 
            ...
            <div class="">
                ...
                <h1 class="text-[#151F3C] pt-36 text-7xl max-w-[600px] font-bold max-sm:pl-10 max-xl:pb-10 max-sm:text-3xl ">
                    Form Penambahan <span class="text-[#FF994F]">mentor</span> terbaik
                </h1>
...
<div class="bg-[#FF994F] pb-10 pt-10 mt-10 mb-10">
    ...
    <div>
        ...
        <div>
            <x-input-label for="alamat" class="text-black" :value="__('alamat')" />
            <x-text-input id="alamat" class="block mt-1 w-1/2 " type="text" name="alamat" :value="old('alamat')"  autofocus />
